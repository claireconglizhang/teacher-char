...
We draw a large, nationally representative sample from the publicly available, baseline (2013/14) data of China Education Panel Survey (CEPS). Unit of analysis is student and data is clustered in nature. Levels of clusters:
...
---
# Results part 2: the effects of teacher experence
...
---
### However, the effects of teacher gender or gender match are likely biased
#### Evidence 1: Girls outperform boys

<img src="gap.png" style="width: 90%" />

---
#### Evidence 2: Gender match is in favor of girls due to the fact that female teachers outnumber male teachers

<img src="matched.png" style="width: 60%" />

---
#### Evidence 3: the effects of teacher gender or gender match are larger for girls (compared to the average point estimates) but are not different from zero for boys
...
We found evidence that gender match has causal impact on female students.

However, due to the coincidence of girls outperforming boys AND female teachers outnumbering male teachers in many educational settings (e.g., Chinese middle schools), the estimated teacher gender effect - although seems not biased - is not generalizable to the population of interest.

Just like if you oversample white students (given the assumption that white students outperforming African American students) and estimate the effects of an variable in favor of white students on student outcomes, your point estimation is not generalizable to the population.
...
Due to the methodological issue with teacher gender effects, and potential (although very small) selection bias, it looks like propensity score matching or weighting will help improving internal validity.

Below is something from internet:
