...
---
### Rethink teacher gender effects

There is a considerable literature body investigating the effects of teacher gender and gender match on student outcomes (e.g., Gong et al., 2018). However, the effects are likely to be overestimated due to the simultaneity of girls outperforming boys and female teachers outnumbering male teachers. Controlling for student gender (identical to gender fixed effects) does not make this bias go away (similar to oversampling issue).

My hypothesis is:

 - Teacher gender does not have causal impact on either girls or boys
 - Gender match has causal impact on girls but not boys
 
How do I address this bias?
