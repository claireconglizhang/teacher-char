...
---
# Results part 1: the effects of teacher education background ("tchgrad" is biased)
...
---
# Results part 3: the effects of teacher gender (both "tchfemale" and "match" are biased)
